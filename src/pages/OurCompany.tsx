...
const OurCompany = () => {
  ...
  return (
    <div className="min-h-screen bg-portfolio-bg">
      <SEO
        title="Our Company, UV"
        description="Learn about UV Agency's mission, values, and the team behind our innovative media experiences. Discover how we're shaping the future of creative events and production."
        pageType="company"
      />
          ...
          <div className="max-w-[95%] sm:max-w-[90%] mx-auto">
            <div className="border-b border-portfolio-divider pb-4 sm:pb-6 mb-4 sm:mb-8">
              <div className="flex items-center gap-2 sm:gap-4 flex-wrap">
                ...
                <h1 className="text-2xl sm:text-4xl md:text-7xl font-bold text-portfolio-text tracking-[-0.02em]">{companyInfo.name}</h1>
